...
*/
ALTER TABLE orders
ALTER COLUMN _order_date TYPE DATE
USING TO_DATE(_order_date, 'DD/MM/YYYY');

SELECT DISTINCT orders.user_id, first_name, last_name
FROM users
JOIN orders ON users.id = orders.user_id
WHERE EXTRACT(YEAR FROM orders._order_date) = 2022
  AND EXTRACT(MONTH FROM orders._order_date) BETWEEN 9 AND 11;
